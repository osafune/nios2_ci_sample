...
#set sdrclk_ports	[get_ports DRAMCLK_OUT]
#
...
#set_output_delay -clock sdram_clock -max $sdram_tsu [get_ports DRAM_*]
#set_output_delay -clock sdram_clock -min $sdram_th [get_ports DRAM_*]
#set_input_delay -clock sdram_clock [expr $sdram_tco - $sdrclk_period] [get_ports DRAM_DQ\[*\]]
